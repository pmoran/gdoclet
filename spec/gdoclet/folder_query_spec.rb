...
describe GDoclet::FolderQuery do
  ...
  context "#contents" do
    ...
    it "should return a folder's as a xml" do
      fake_get("/feeds/default/private/full/folder:12345/contents?xoauth_requestor_id=", @folder_feed)
  ...
  context "#by_title" do
    ...
    it "should return a folder as a document list entry" do
      fake_get("/feeds/default/private/full?showfolders=true&title=folder title&title-exact=true&category=folder&xoauth_requestor_id=", @folder_feed)
